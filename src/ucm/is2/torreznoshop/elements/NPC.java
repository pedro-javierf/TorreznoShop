...
public class NPC extends GameEntity {
	...
	Room currentRoom;
	public NPC(String name,int hp, int money, Room startingRoom, int xpos, int posy, boolean haveTorreznos) {
		super(hp, money, 0, startingRoom, xpos, posy, haveTorreznos);
